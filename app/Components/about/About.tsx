  ...
  return (
    <div className="about-main">
      ...
      <div className="about-submiddle">
        <span className="sen1">
          I <span className="highlight">develop</span> full-stack web
          applications
        </span>
        <div className="sen-merge">
          <span className="sen2">
            MERN Stack Developer who loves crafting interfaces
          </span>
          <button
            onClick={() =>
              (window.location.href =
                "mailto:sruthisukumaran07@gmail.com?subject=Project Inquiry&body=Hi Sruthi, I would like to connect.")
            }
            className="hire-Btn"
          >
            Hire Me
